...
describe('MedicosComponent', () => {
	...
	it('Init: Debe de cargar los médicos', () => {
		const medicosArray = ['medico1', 'medico4', 'medico3'];
		spyOn(servicio, 'getMedicos').and.callFake(() => {
			return from([medicosArray]);
		});
		componente.ngOnInit();
	...
	it('Debe de llamar al servidor para que sea borrado', () => {
	...
	it('No debe de llamar al servidor para que sea borrado', () => {
